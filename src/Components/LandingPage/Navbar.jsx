      ...
      <nav className={`flex items-center mb-2 relative z-50 ${signup ? 'justify-between' : 'justify-between md:justify-start md:gap-8'}`}>
        ...
        {signup ? (
          <div className="md:hidden flex items-center gap-3">
            {/* Sign Up Button */}
            <button className="bg-yellow-400 text-black px-4 py-2 rounded-full text-xs font-semibold hover:bg-yellow-300 transition">
              Sign Up
            </button>
      ...
      <div className={`md:hidden fixed top-0 right-0 h-full w-72 bg-slate-900 shadow-2xl transform transition-transform duration-300 ease-in-out z-50 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="flex flex-col p-8 pt-20">
          ...
          <ul className="flex flex-col gap-6 text-base text-gray-300">
            <li className="hover:text-yellow-400 cursor-pointer transition border-b border-gray-700 pb-3">Home</li>
            <li className="hover:text-yellow-400 cursor-pointer transition border-b border-gray-700 pb-3">About</li>
            <li className="hover:text-yellow-400 cursor-pointer transition border-b border-gray-700 pb-3">Business</li>
            <li className="hover:text-yellow-400 cursor-pointer transition border-b border-gray-700 pb-3">Foundation</li>
          </ul>
        </div>
      </div>
    </>
