...
function Foundation() {
    return (
        <div className="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-black z-10 relative " >
            <div className='w-full bg-cover bg-no-repeat h-screen flex flex-col items-center justify-center' style={{ backgroundImage: `url(${HSun})` }}>
                <div className='w-full h-50 items-center flex justify-center '>
                    <img
                        ...
                        className="w-55 h-42 object-cover rounded-lg "
                    />
